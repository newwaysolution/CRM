	...
	<div class="section_content">
		<span class="section_content_top"></span>
			<div class="section_content_inner">
				<form action="CompanyController?action=AddEnableCompany" class="search_form" id="regform" method="post">
					<fieldset>
					<div class="forms">
						...
						<div class="forms">
							<div class="row">
								<div class="inputs">
									<span class="button blue_button"><span><span>Enable</span></span><input name="search" type="submit" id="submit"/></span>
								</div>
							</div>
							</div>
						</fieldset>
